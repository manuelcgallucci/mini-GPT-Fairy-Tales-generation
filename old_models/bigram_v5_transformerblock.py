...
n_heads = 4 # n_embd / n_heads = block_size
# =============
...
"""
Step 2700: Train Loss 0.2935, Val Loss 0.2979
Example:

II-a sit ass dackareo repseno me had a lwer Ifaren the and thever? Gcor fadte "Ithed and atreswhoughe sloucue the Sershe paamrther lout aboted for the

the othe begher Isang wast, as the cout he the sako ave wito feld and tim a benkest the ust atang she whosw isand ofok whan ith san pithe n at reny reas urd fiee at ast dout achapha gald vabfat wome mput ther al of usn thevere wam shee was tho and the shat ass iblen mul?"

Hothed I hee con had llieghefagered has ses thul the Jofam and hhen as and
"""